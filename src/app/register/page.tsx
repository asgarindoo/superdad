        ...
        <Card className="border-border shadow-soft bg-card p-4 sm:p-6">
          <CardContent className="flex flex-col gap-6 pt-6">
            <div className="text-center">
              <h1 className="text-2xl font-heading font-medium text-primary-text mb-2">Build Your Home</h1>
              <p className="text-secondary-text text-sm">Create an account to start your journey.</p>
            </div>

            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              <div className="flex flex-col gap-2">
                <label className="text-sm font-medium text-primary-text" htmlFor="name">Preferred Name</label>
                <Input id="name" type="text" placeholder="What should he call you?" className="h-12" />
              </div>
